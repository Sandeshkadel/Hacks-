// Render projects on projects.html (live updates) into #projects-grid or #projects-list-public
(function(){
  ...
  async function render(){
    const box = $('#projects-grid') || $('#projects-list-public'); if (!box) return;
    const d = await S.getData(); const arr = d.projects || [];
