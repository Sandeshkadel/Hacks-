// Render sponsors on sponsors.html (live updates) into #sponsors-grid or #sponsors-list-public
(function(){
  ...
  async function render(){
    const box = $('#sponsors-grid') || $('#sponsors-list-public'); if (!box) return;
    const d = await S.getData(); const arr = d.sponsors || [];
